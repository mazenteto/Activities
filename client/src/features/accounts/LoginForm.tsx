...
const loginWithGithub=()=>{
  ...
  window.location.href=
    `https://github.com/login/oauth/authorize?client_id=${clientId}&redirecturl=${redirectUrl}&scope=read:user user:email`
}
      ...
      {notVerified ? (
        ...
        >
          <Typography textAlign={"center"} color="error">
            Your email is not verified. You can click the button to re-send the
            verification email
          </Typography>
          <Button
